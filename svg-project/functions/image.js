// functions/image.js 파일의 전체 내용입니다.

// --- 기존 헬퍼 함수들은 여기에 그대로 존재합니다 ---
...
function createSvg({ width, height, imageUrl, image, lines, fontSize, name }, doCache) {
  ...
  if (doCache) {
    // Pages에서는 이 헤더가 덮어씌워지지 않고 그대로 작동합니다.
    responseOptions.headers['Cache-Control'] = 'public, max-age=31536000, immutable';
  }
...
// --- Worker 코드를 Pages Function 형식으로 변경한 부분 ---
